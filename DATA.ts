...
export interface IMAGES_TYPE {
  thumbnail: ImageRequireSource;
  hero: {
    small: ImageRequireSource;
    large: ImageRequireSource;
  },
  gallery: ImageRequireSource;
}
...
export const DATA : DATA_TYPE [] = [
    {
      ...
      "artist": {
        "image": require("./assets/starry-night/artist.jpg"),
        "name": "Vincent Van Gogh"
      },
      "images": {
        "thumbnail": require("./assets/starry-night/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/starry-night/hero-small.jpg"),
          "large": require("./assets/starry-night/hero-large.jpg")
        },
        "gallery": require("./assets/starry-night/gallery.jpg")
      }
    },
    {
      id: 2,
      ...
      "artist": {
        "image": require("./assets/girl-with-pearl-earring/artist.jpg"),
        "name": "Johannes Vermeer"
      },
      "images": {
        "thumbnail": require("./assets/girl-with-pearl-earring/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/girl-with-pearl-earring/hero-small.jpg"),
          "large": require("./assets/girl-with-pearl-earring/hero-large.jpg")
        },
        "gallery": require("./assets/girl-with-pearl-earring/gallery.jpg")
      }
    },
    {
      id: 3,
      ...
      "artist": {
        "image": require("./assets/guernica/artist.jpg"),
        "name": "Pablo Picasso"
      },
      "images": {
        "thumbnail": require("./assets/guernica/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/guernica/hero-small.jpg"),
          "large": require("./assets/guernica/hero-large.jpg")
        },
        "gallery": require("./assets/guernica/gallery.jpg")
      }
    },
    {
      id: 4,
      ...
      "artist": {
        "image": require("./assets/penitent-magdalene/artist.jpg"),
        "name": "Artemisia Gentileschi"
      },
      "images": {
        "thumbnail": require("./assets/penitent-magdalene/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/penitent-magdalene/hero-small.jpg"),
          "large": require("./assets/penitent-magdalene/hero-large.jpg")
        },
        "gallery": require("./assets/penitent-magdalene/gallery.jpg")
      }
    },
    {
      id: 5,
      ...
      "artist": {
        "image": require("./assets/the-storm-on-the-sea-of-galilee/artist.jpg"),
        "name": "Rembrandt"
      },
      "images": {
        "thumbnail": require("./assets/the-storm-on-the-sea-of-galilee/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/the-storm-on-the-sea-of-galilee/hero-small.jpg"),
          "large": require("./assets/the-storm-on-the-sea-of-galilee/hero-large.jpg")
        },
        "gallery": require("./assets/the-storm-on-the-sea-of-galilee/gallery.jpg")
      }
    },
    {
      id: 6,
      ...
      "artist": {
        "image": require("./assets/the-great-wave-off-kanagawa/artist.jpg"),
        "name": "Hokusai"
      },
      "images": {
        "thumbnail": require("./assets/the-great-wave-off-kanagawa/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/the-great-wave-off-kanagawa/hero-small.jpg"),
          "large": require("./assets/the-great-wave-off-kanagawa/hero-large.jpg")
        },
        "gallery": require("./assets/the-great-wave-off-kanagawa/gallery.jpg")
      }
    },
    {
      id: 7,
      ...
      "artist": {
        "image": require("./assets/van-gogh-self-portrait/artist.jpg"),
        "name": "Vincent Van Gogh"
      },
      "images": {
        "thumbnail": require("./assets/van-gogh-self-portrait/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/van-gogh-self-portrait/hero-small.jpg"),
          "large": require("./assets/van-gogh-self-portrait/hero-large.jpg")
        },
        "gallery": require("./assets/van-gogh-self-portrait/gallery.jpg")
      }
    },
    {
      id: 8,
      ...
      "artist": {
        "image": require("./assets/the-sleeping-gypsy/artist.jpg"),
        "name": "Henri Rousseau"
      },
      "images": {
        "thumbnail": require("./assets/the-sleeping-gypsy/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/the-sleeping-gypsy/hero-small.jpg"),
          "large": require("./assets/the-sleeping-gypsy/hero-large.jpg")
        },
        "gallery": require("./assets/the-sleeping-gypsy/gallery.jpg")
      }
    },
    {
      id: 9,
      ...
      "artist": {
        "image": require("./assets/lady-with-an-ermine/artist.jpg"),
        "name": "Leonardo da Vinci"
      },
      "images": {
        "thumbnail": require("./assets/lady-with-an-ermine/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/lady-with-an-ermine/hero-small.jpg"),
          "large": require("./assets/lady-with-an-ermine/hero-large.jpg")
        },
        "gallery": require("./assets/lady-with-an-ermine/gallery.jpg")
      }
    },
    {
      id: 10,
      ...
      "artist": {
        "image": require("./assets/the-night-cafe/artist.jpg"),
        "name": "Vincent Van Gogh"
      },
      "images": {
        "thumbnail": require("./assets/the-night-cafe/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/the-night-cafe/hero-small.jpg"),
          "large": require("./assets/the-night-cafe/hero-large.jpg")
        },
        "gallery": require("./assets/the-night-cafe/gallery.jpg")
      }
    },
    {
      id: 11,
      ...
      "artist": {
        "image": require("./assets/the-basket-of-apples/artist.jpg"),
        "name": "Paul Cézanne"
      },
      "images": {
        "thumbnail": require("./assets/the-basket-of-apples/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/the-basket-of-apples/hero-small.jpg"),
          "large": require("./assets/the-basket-of-apples/hero-large.jpg")
        },
        "gallery": require("./assets/the-basket-of-apples/gallery.jpg")
      }
    },
    {
      id: 12,
      ...
      "artist": {
        "image": require("./assets/the-boy-in-the-red-vest/artist.jpg"),
        "name": "Paul Cézanne"
      },
      "images": {
        "thumbnail": require("./assets/the-boy-in-the-red-vest/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/the-boy-in-the-red-vest/hero-small.jpg"),
          "large": require("./assets/the-boy-in-the-red-vest/hero-large.jpg")
        },
        "gallery": require("./assets/the-boy-in-the-red-vest/gallery.jpg")
      }
    },
    {
      id: 13,
      ...
      "artist": {
        "image": require("./assets/arnolfini-portrait/artist.jpg"),
        "name": "Jan van Eyck"
      },
      "images": {
        "thumbnail": require("./assets/arnolfini-portrait/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/arnolfini-portrait/hero-small.jpg"),
          "large": require("./assets/arnolfini-portrait/hero-large.jpg")
        },
        "gallery": require("./assets/arnolfini-portrait/gallery.jpg")
      }
    },
    {
      id: 14,
      ...
      "artist": {
        "image": require("./assets/mona-lisa/artist.jpg"),
        "name": "Leonardo da Vinci"
      },
      "images": {
        "thumbnail": require("./assets/mona-lisa/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/mona-lisa/hero-small.jpg"),
          "large": require("./assets/mona-lisa/hero-large.jpg")
        },
        "gallery": require("./assets/mona-lisa/gallery.jpg")
      }
    },
    {
      id: 15,
      ...
      "artist": {
        "image": require("./assets/the-swing/artist.jpg"),
        "name": "Jean-Honoré Fragonard"
      },
      "images": {
        "thumbnail": require("./assets/the-swing/thumbnail.jpg"),
        "hero": {
          "small": require("./assets/the-swing/hero-small.jpg"),
          "large": require("./assets/the-swing/hero-large.jpg")
        },
        "gallery": require("./assets/the-swing/gallery.jpg")
      }
    }
]
